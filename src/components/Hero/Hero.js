...
function Hero() {
  return (
    <>
    <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[630px]">
        {/* Brand Info */}
        ...
        <div className="flex justify-center items-center">
          ...
          src={HeroPng} alt='Hero' className="w-[350px] md:w-[550px] drop-shadow" />
        </div>
        <div className=" absolute top-14 md:top-0 right-1/2 blur-sm opacity-80 rotate-[40deg]">
          ...
          src={leafPng} alt='' className="w-full md:max-w-[350px]" /> 
        </div>
      </div>
    </section>
    </>
